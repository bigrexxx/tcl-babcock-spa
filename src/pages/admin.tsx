...
export default function AdminPage() {
  ...
  useEffect(() => {
    document.title = "Admin — TCL Babcock";
        ...
        <div className="page-wrap">
          <div className="wizard-card" style={{ maxWidth: 520, margin: "2rem auto", textAlign: "center" }}>
            ...
            <p style={{ color: "var(--muted)", margin: "1rem 0" }}>
              Your account is signed in but doesn't have admin access. Ask an existing TCL admin to grant your account the <code>admin</code> role, then refresh.
            </p>
